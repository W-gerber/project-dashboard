...
function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      ...
      >
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-500 to-indigo-600 p-10 rounded-l-lg flex-col justify-between">
          <div>
        ...
        <div className="w-full md:w-1/2 p-10 flex flex-col justify-between">
          ...
          <form onSubmit={handleRegister}>
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 text-white py-2 rounded-md font-semibold hover:bg-indigo-700 transition-colors mb-4"
            >
              Sign Up
            </button>
